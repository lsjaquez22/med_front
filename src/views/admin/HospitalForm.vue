        ...
        >
          <form @submit.prevent="submit">
            ...
            <div class="footer-menu-cliente">
              ...
              <router-link slot="right" to="/admin" class="button is-danger">
                Cancelar
              </router-link>
            </div>
          </form>
  ...
  computed: {
    titleStack () {
      ...
      if (this.isProfileExists) {
        ...
        lastCrumb = 'Nuevo Hospital'
      }

      return ['Hospital', lastCrumb]
    },
    heroTitle () {
      if (this.isProfileExists) {
        return this.form.name
      } else {
        return 'Nuevo Hospital'
      }
    },
    heroRouterLinkTo () {
      if (this.isProfileExists) {
        return { name: 'hospital.new' }
      } else {
        return '/admin'
      }
    },
